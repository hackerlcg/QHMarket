package com.qianhua.market.net.interceptor;
...
public class AccessHeadInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        Request.Builder builder = request.newBuilder()
                ...
                .addHeader("accessKey", APIConfig.ACCESS_KEY);
        StringBuilder sb = new StringBuilder(APIConfig.SECRET_KEY).append(reqTime);
