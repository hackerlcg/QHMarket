...
import com.qianhua.market.base.App;
...
public class CommonUtils {
    ...
    public static String getVersionName() {
        try {
            // 获取packagemanager的实例
            PackageManager packageManager = App.Companion.getInstance().getPackageManager();
            // getPackageName()是你当前类的包名，0代表是获取版本信息
            PackageInfo packInfo;
            packInfo = packageManager.getPackageInfo(App.Companion.getInstance().getPackageName(),
                    0);
    ...
    public static int getVersionCode() {
        ...
        try {
            PackageManager packageManager = App.Companion.getInstance().getPackageManager();
            packInfo = packageManager.getPackageInfo(App.Companion.getInstance().getPackageName(), 0);
        } catch (PackageManager.NameNotFoundException e) {
            e.printStackTrace();
        }
