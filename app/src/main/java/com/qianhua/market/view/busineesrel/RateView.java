package com.qianhua.market.view.busineesrel;
...
public class RateView extends LinearLayout {
    ...
    public void setRate(int star, boolean half) {
        switch (star) {
            case 5:
                stars[4].setImageResource(R.drawable.star_full);
            case 4:
                stars[3].setImageResource(R.drawable.star_full);
            case 3:
                stars[2].setImageResource(R.drawable.star_full);
            case 2:
                stars[1].setImageResource(R.drawable.star_full);
            case 1:
                stars[0].setImageResource(R.drawable.star_full);
                break;
            default:
                break;
        }
        if (half && star >= 1 && star <= 5) {
            stars[star - 1].setImageResource(R.drawable.star_half);
        }
    }
}
