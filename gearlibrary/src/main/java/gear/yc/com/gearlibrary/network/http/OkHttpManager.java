...
public class OkHttpManager {
    ...
    Interceptor interceptorCom = null;

    public OkHttpManager setInterceptorCom(Interceptor interceptorCom) {
        this.interceptorCom = interceptorCom;
        return instance;
    }

    public OkHttpManager build(){
        if (okHttpClient == null) {
            if(interceptorCom == null){
